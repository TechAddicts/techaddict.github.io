    ...
    // Search Modal
    // --------------------------
    var smbg = $('#search-modal-bg'),
        smbgee = $('#search-modal-bg #search-modal, .exit'),
        sbody = $('body'); $('a.search-project').on('click', function() {
        smbg.addClass('appear');
        sbody.addClass('modal-open');
        setTimeout(function() {
            smbgee.addClass('pop');
        }, 300);
        return false;
    }); $('#search-modal-bg .exit').on('click', function() {
        smbg.removeClass('appear');
        smbgee.removeClass('pop');
        sbody.removeClass('modal-open');
        return false;
    });
